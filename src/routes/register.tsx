...
const registerSchema = z
      .object({
            ...
            isTermsAndConditionAccepted: z.literal(true, {
                  ...
                  <div className="w-full max-w-lg animate-in fade-in slide-in-from-bottom-8 duration-700">
                        ...
                        <div className="flex flex-col items-center mb-10">
                              ...
                              <h1 className="text-4xl font-black text-text-primary tracking-tighter mb-2">
                                    Join <span className="text-accent underline">Us</span>
                              </h1>
                              <p className="text-text-secondary font-medium tracking-tight">
                                    Create your performance space
                              </p>
                        </div>
                        ...
                        <div className="bg-bg-secondary/50 backdrop-blur-xl border border-border p-10 rounded-[2.5rem] shadow-2xl shadow-accent/5">
                              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                    ...
                                    <label className="flex items-center gap-3 cursor-pointer group p-2 hover:bg-bg-hover rounded-2xl transition-colors">
                                          <input
                                          ...
                                          <span className="text-xs font-medium text-text-secondary select-none">
                                                ...
                                                and{' '}
                                                <span className="text-accent underline font-bold">Privacy Policy</span>
                                          </span>
                                    </label>
                                    {errors.isTermsAndConditionAccepted && (
                                          <p className="text-[10px] font-black text-danger ml-4 uppercase tracking-widest mt-[-1rem]">
